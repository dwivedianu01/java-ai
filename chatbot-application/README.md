...
```bash
git clone https://github.com/dwivedianu01/java-ai.git
cd backend
```
...
1. **Copy open ai key in application.yaml**:
...
- **`GET /ai/message/string`**: Accepts a `message` query parameter and returns a response generated by the AI model.
  - **Example**: `http://localhost:8080/ai/message/string?message=Tell me about Spring AI`
  
- **`POST /ai/message`**: Accepts a JSON body with a `message` field and returns a response generated by the AI model.
  - **Example**:
    ```json
    POST http://localhost:8080/ai/message
    Content-Type: application/json
    
    {
      "message": "Explain how to use openai apis"
    }
    ```
